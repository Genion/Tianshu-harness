...
> **版权与许可**：本文档采用 [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh-hans) 许可——署名 / 非商业性使用 / 禁止演绎。可以署名转载原文链接，但不得改编、摘编、洗稿或用于商业用途；引用请注明出处「天枢 Tianshu Harness · CVM 实证报告（2026-05）」。本仓库代码部分的 Apache 2.0 许可**不适用**于本文档。
